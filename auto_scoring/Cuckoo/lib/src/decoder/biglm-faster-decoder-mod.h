...
#ifndef KALDI_DECODER_BIGLM_FASTER_DECODER_MOD_H_
#define KALDI_DECODER_BIGLM_FASTER_DECODER_MOD_H_
...
typedef FasterDecoderOptions BiglmFasterDecoderModOptions;
...
class BiglmFasterDecoderMod {
 public:
  ...
  // lm_diff_fst.
  BiglmFasterDecoderMod(const fst::Fst<fst::StdArc> &fst,
                     const BiglmFasterDecoderModOptions &opts,
  ...
  void SetOptions(const BiglmFasterDecoderModOptions &opts) { opts_ = opts; }

  ~BiglmFasterDecoderMod() {
...
// private:
  ...
  BiglmFasterDecoderModOptions opts_;
  bool warned_noarc_;
  ...
  KALDI_DISALLOW_COPY_AND_ASSIGN(BiglmFasterDecoderMod);
};
