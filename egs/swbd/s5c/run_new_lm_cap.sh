...
set -e # exit on error
has_fisher=true
#local/swbd1_data_download.sh /nfs/corpus0/data/corpora/switchboard/sw-asr/switchboard1
...
#local/swbd1_data_prep.sh /nfs/corpus0/data/corpora/switchboard/sw-asr/switchboard1
...
#fisher_dirs=/nfs/corpus0/data/corpora/fisher/transcripts/part*
...
lexicon=/work3/tzy/github/kaldi_master_20160126_interspeech16_cuda7.0/egs/wsj/s5/data/local/dict/lexicon.txt
local/swbd1_train_lms_tmp.sh data/local/train/text.cap \
  $lexicon data/local/lm $fisher_dirs
...
#local/eval2000_data_prep.sh /nfs/corpus0/data/corpora/hub5/2000 /nfs/corpus0/data/corpora/hub5/2000/transcr
...
#mfccdir=mfcc
#cp -rf data data_fbank

#for x in eval2000; do
#  steps/make_mfcc.sh --nj 32 --cmd "$train_cmd" \
#    data_mfcc_energy/$x data_mfcc_energy/$x/mfcc/log data_mfcc_energy/$x/mfcc
#  steps/compute_cmvn_stats.sh data_mfcc_energy/$x data_mfcc_energy/$x/mfcc/log data_mfcc_energy/$x/mfcc
#  utils/fix_data_dir.sh data_mfcc_energy/$x
#done
#
#exit 0
#
...
#    data_fbank/$x data_fbank/$x/fbank/log data_fbank/$x/fbank
#  steps/compute_cmvn_stats.sh data_fbank/$x data_fbank/$x/fbank/log data_fbank/$x/fbank
#  utils/fix_data_dir.sh data_fbank/$x
#done
#
#
#exit 0
...
lang=/work3/tzy/github/kaldi_master_20160126_interspeech16_cuda7.0/egs/wsj/s5/data/lang
lexicon=/work3/tzy/github/kaldi_master_20160126_interspeech16_cuda7.0/egs/wsj/s5/data/local/dict/lexicon.txt

srilm_opts="-subset -prune-lowprobs -unk -tolower -order 3"
utils/format_lm_sri.sh --srilm-opts "$srilm_opts" \
  $lang $LM $lexicon /work3/tzy/github/kaldi_master_20160126_interspeech16_cuda7.0/egs/wsj/s5/data/lang_sw1_tg
LM=data/local/lm/sw1_fsh.o4g.kn.gz
if $has_fisher; then
  utils/build_const_arpa_lm.sh $LM $lang /work3/tzy/github/kaldi_master_20160126_interspeech16_cuda7.0/egs/wsj/s5/data/lang_sw1_fsh_fg
fi
