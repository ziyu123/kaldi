...
ngram -map-unk '<UNK>' -unk -lm $dir/sw1.o3g.kn.gz -ppl $dir/heldout
ngram -map-unk '<UNK>' -unk -lm $dir/sw1.o3g.kn.gz -ppl $dir/heldout -debug 2 >& $dir/3gram.ppl2
...
ngram -map-unk '<UNK>' -unk -lm $dir/sw1.o4g.kn.gz -ppl $dir/heldout
ngram -map-unk '<UNK>' -unk -lm $dir/sw1.o4g.kn.gz -ppl $dir/heldout -debug 2 >& $dir/4gram.ppl2
# file data/local/lm/heldout: 10000 sentences, 118254 words, 0 OOVs
...
if [ -f $dir/fisher/text0 ]; then
  ...
  for x in 3 4; do
    ...
    ngram -map-unk '<UNK>' -unk -lm $dir/fisher/fisher.o${x}g.kn.gz -ppl $dir/heldout
    ngram -map-unk '<UNK>' -unk -lm $dir/fisher/fisher.o${x}g.kn.gz -ppl $dir/heldout -debug 2 \
    ...
    ngram -map-unk '<UNK>' -order $x -lm $dir/sw1.o${x}g.kn.gz -lambda $swb1_weight \
      -mix-lm $dir/fisher/fisher.o${x}g.kn.gz \
      -unk -write-lm $dir/sw1_fsh.o${x}g.kn.gz
    echo "PPL for SWBD1 + Fisher ${x}gram LM:"
    ngram -map-unk '<UNK>' -unk -lm $dir/sw1_fsh.o${x}g.kn.gz -ppl $dir/heldout
  done
fi
