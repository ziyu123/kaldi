...
# training options
num_epochs=10
initial_effective_lrate=0.0006 #0.0006
final_effective_lrate=0.00006  #0.00006
num_jobs_initial=2
num_jobs_final=12
momentum=0.5
...
common_egs_dir=exp/nnet3/egs_merge_no_shuffle
dir=exp/nnet3/lstm_asr_multitask_raw_net_solo_r

if [ $stage -le 8 ]; then
  steps/nnet3/lstm/train_raw_from_egs_no_shuffle.sh --stage $train_stage \
