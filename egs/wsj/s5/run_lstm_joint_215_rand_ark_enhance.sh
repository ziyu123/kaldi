...
common_egs_dir=exp/nnet3/partial_egs_rand_ark_558
dir=exp/nnet3/lstm_joint_i_partial_rand_ark_558_enhance

if [ $stage -le 8 ]; then
  steps/nnet3/lstm/train_speech_spk_partial_enhance_215.sh --stage $train_stage \
    ...
    --max-gpu-num 4 \
    data_fbank/train data_fbank/lang exp/tri4_ali exp/spk_ali $dir  || exit 1;
fi
