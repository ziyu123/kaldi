...
if [ $stage -le 3 ]; then
  ...
  $cmd $dir/log/create_valid_subset.log \
    nnet3-get-egs-ivector-in --num-pdfs=$num_pdfs $valid_ivector_opt $valid_egs_opts "$valid_feats" \
    "ark,s,cs:ali-to-post scp:$dir/ali_special.scp ark:- |" \
    "ark:$dir/valid_all.egs" || touch $dir/.error &
  $cmd $dir/log/create_train_subset.log \
    nnet3-get-egs-ivector-in --num-pdfs=$num_pdfs $train_subset_ivector_opt $valid_egs_opts "$train_subset_feats" \
     "ark,s,cs:ali-to-post scp:$dir/ali_special.scp ark:- |" \
...
if [ $stage -le 4 ]; then
  ...
  $cmd JOB=1:$nj $dir/log/get_egs.JOB.log \
    nnet3-get-egs-ivector-in --num-pdfs=$num_pdfs $ivector_opt $egs_opts --num-frames=$frames_per_eg "$feats" \
