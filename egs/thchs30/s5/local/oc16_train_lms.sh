...
ngram-count -text $dir/train.gz -order 3 -limit-vocab -vocab $dir/wordlist \
  -unk -map-unk "!SIL" -kndiscount -interpolate -lm $dir/oc.o3g.kn.gz
echo "PPL for OC16 trigram LM:"
ngram -unk -lm $dir/oc.o3g.kn.gz -ppl $dir/heldout
ngram -unk -lm $dir/oc.o3g.kn.gz -ppl $dir/heldout -debug 2 >& $dir/3gram.ppl2
